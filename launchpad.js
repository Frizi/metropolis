...
import brightnessSteps from 'launchpad-mini/lib/brightness'
import Buttons from 'launchpad-mini/lib/button-list'
import buttons from 'launchpad-mini/lib/buttons'
import colors from 'launchpad-mini/lib/colors'

/**
 * @param port MIDI port object
 * @returns {Array.<{portNumber:Number, portName:String}>}>}
 */
function findLaunchpadPorts ( port ) {
...
class Launchpad extends EventEmitter {
    ...
    constructor(midi) {
        ...
        this.midiIn.on( 'onMIDIMessage', ( dt, msg ) => this._processMessage( dt, msg ) );
